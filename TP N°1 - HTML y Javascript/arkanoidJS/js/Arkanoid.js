...
/**
 * Función constructora del contador de puntaje
 * 
 * @param int x      Posición del score en el eje x
 * @param int y      Posición del score en el eje y
 * @param int width  Tamaño del score en el eje x
 * @param int height Tamaño del score en el eje y
 */
...
/**
 * Función constructora del contador de vidas
 * 
 * @param int x      Posición de la vida en el eje x
 * @param int y      Posición de la vida en el eje y
 * @param int width  Tamaño de la vida en el eje x
 * @param int height Tamaño de la vida en el eje y
 */
function Life(x, y, width, height){
	this.x = x;
	this.y = y;
	this.width = width;
	this.height = height;
...
function Arkanoid(canvas) {
	...
	const BULLET_SIZE = 3;
	const BULLET_MAX_SPEED = 30;
	const SCORE_WIDTH = 230;
	const SCORE_HEIGHT = 420;
	...
	this.createElements = function() {
		...
		this.score = new Score(canvas.width / 2 + SCORE_WIDTH / 2, canvas.height - SCORE_HEIGHT, "30px", "Consolas");
	...
	this.drawScore = function(){
		this.context.font = this.score.width + " " + this.score.height;
		this.context.fillStyle = 'yellow';
		this.context.fillText(this.score.text, this.score.x, this.score.y);
	}
...
/*
	this.restartGame = function(){
		...
		this.context.fillStyle = 'rgb(255,255,0)';
		this.context.createElement("BUTTON");
